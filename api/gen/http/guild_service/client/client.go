...
//
// GuildService client HTTP transport
//
// Command:
...
// Client lists the GuildService service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the GuildService service servers.
func NewClient(
	scheme string,
	host string,
	doer goahttp.Doer,
...
// GuildService service GetAllGuilds server.
func (c *Client) GetAllGuilds() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("GuildService", "GetAllGuilds", err)
		}
...
// GuildService service GetSingleGuild server.
func (c *Client) GetSingleGuild() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("GuildService", "GetSingleGuild", err)
		}
		return decodeResponse(resp)
	}
}
...
// GuildService service GetGuildMembers server.
func (c *Client) GetGuildMembers() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("GuildService", "GetGuildMembers", err)
		}
		return decodeResponse(resp)
	}
}
...
// GuildService service GetGuildMasterAddress server.
func (c *Client) GetGuildMasterAddress() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("GuildService", "GetGuildMasterAddress", err)
		}
		return decodeResponse(resp)
	}
}
...
// GuildService service GetGuildDefaultMember server.
func (c *Client) GetGuildDefaultMember() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("GuildService", "GetGuildDefaultMember", err)
		}
		return decodeResponse(resp)
	}
}

// EnterGuild returns an endpoint that makes HTTP requests to the GuildService
...
func (c *Client) EnterGuild() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("GuildService", "EnterGuild", err)
		}
		return decodeResponse(resp)
	}
}

// LeaveGuild returns an endpoint that makes HTTP requests to the GuildService
...
func (c *Client) LeaveGuild() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("GuildService", "LeaveGuild", err)
		}
		return decodeResponse(resp)
	}
}
...
// GuildService service GetGuildMarkets server.
func (c *Client) GetGuildMarkets() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("GuildService", "GetGuildMarkets", err)
		}
		return decodeResponse(resp)
	}
}
...
// GuildService service GetAccountPortfolio server.
func (c *Client) GetAccountPortfolio() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("GuildService", "GetAccountPortfolio", err)
		}
		return decodeResponse(resp)
	}
}
...
// GuildService service GetAccountPortfolios server.
func (c *Client) GetAccountPortfolios() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("GuildService", "GetAccountPortfolios", err)
		}
		return decodeResponse(resp)
	}
}
