...
//
// GuildService HTTP client types
//
// Command:
...
// EnterGuildRequestBody is the type of the "GuildService" service "EnterGuild"
...
// LeaveGuildRequestBody is the type of the "GuildService" service "LeaveGuild"
// endpoint HTTP request body.
...
// GetAllGuildsResponseBody is the type of the "GuildService" service
...
// GetSingleGuildResponseBody is the type of the "GuildService" service
...
// GetGuildMembersResponseBody is the type of the "GuildService" service
...
// GetGuildMasterAddressResponseBody is the type of the "GuildService" service
...
// GetGuildDefaultMemberResponseBody is the type of the "GuildService" service
...
// EnterGuildResponseBody is the type of the "GuildService" service
...
// LeaveGuildResponseBody is the type of the "GuildService" service
...
// GetGuildMarketsResponseBody is the type of the "GuildService" service
...
// GetAccountPortfolioResponseBody is the type of the "GuildService" service
...
// GetAccountPortfoliosResponseBody is the type of the "GuildService" service
...
// GetAllGuildsNotFoundResponseBody is the type of the "GuildService" service
...
// GetAllGuildsInternalResponseBody is the type of the "GuildService" service
...
// GetSingleGuildNotFoundResponseBody is the type of the "GuildService" service
// "GetSingleGuild" endpoint HTTP response body for the "not_found" error.
...
// GetSingleGuildInternalResponseBody is the type of the "GuildService" service
// "GetSingleGuild" endpoint HTTP response body for the "internal" error.
...
// GetGuildMembersNotFoundResponseBody is the type of the "GuildService"
...
// GetGuildMembersInternalResponseBody is the type of the "GuildService"
...
// GetGuildMasterAddressNotFoundResponseBody is the type of the "GuildService"
...
// GetGuildMasterAddressInternalResponseBody is the type of the "GuildService"
// service "GetGuildMasterAddress" endpoint HTTP response body for the
// "internal" error.
...
// GetGuildDefaultMemberNotFoundResponseBody is the type of the "GuildService"
...
// GetGuildDefaultMemberInternalResponseBody is the type of the "GuildService"
// service "GetGuildDefaultMember" endpoint HTTP response body for the
// "internal" error.
...
// EnterGuildNotFoundResponseBody is the type of the "GuildService" service
...
// EnterGuildInternalResponseBody is the type of the "GuildService" service
...
// LeaveGuildNotFoundResponseBody is the type of the "GuildService" service
...
// LeaveGuildInternalResponseBody is the type of the "GuildService" service
...
// GetGuildMarketsNotFoundResponseBody is the type of the "GuildService"
...
// GetGuildMarketsInternalResponseBody is the type of the "GuildService"
...
// GetAccountPortfolioNotFoundResponseBody is the type of the "GuildService"
...
// GetAccountPortfolioInternalResponseBody is the type of the "GuildService"
...
// GetAccountPortfoliosNotFoundResponseBody is the type of the "GuildService"
...
// GetAccountPortfoliosInternalResponseBody is the type of the "GuildService"
// service "GetAccountPortfolios" endpoint HTTP response body for the
// "internal" error.
...
// the "EnterGuild" endpoint of the "GuildService" service.
func NewEnterGuildRequestBody(p *guildservice.EnterGuildPayload) *EnterGuildRequestBody {
...
// the "LeaveGuild" endpoint of the "GuildService" service.
func NewLeaveGuildRequestBody(p *guildservice.LeaveGuildPayload) *LeaveGuildRequestBody {
...
// NewGetAllGuildsResultOK builds a "GuildService" service "GetAllGuilds"
// endpoint result from a HTTP "OK" response.
func NewGetAllGuildsResultOK(body *GetAllGuildsResponseBody) *guildservice.GetAllGuildsResult {
	v := &guildservice.GetAllGuildsResult{}
	if body.Guilds != nil {
		v.Guilds = make([]*guildservice.Guild, len(body.Guilds))
		for i, val := range body.Guilds {
			v.Guilds[i] = unmarshalGuildResponseBodyToGuildserviceGuild(val)
		}
	}
...
// NewGetAllGuildsNotFound builds a GuildService service GetAllGuilds endpoint
// not_found error.
...
// NewGetAllGuildsInternal builds a GuildService service GetAllGuilds endpoint
// internal error.
...
// NewGetSingleGuildResultOK builds a "GuildService" service "GetSingleGuild"
// endpoint result from a HTTP "OK" response.
func NewGetSingleGuildResultOK(body *GetSingleGuildResponseBody) *guildservice.GetSingleGuildResult {
	v := &guildservice.GetSingleGuildResult{}
	if body.Guild != nil {
		v.Guild = unmarshalGuildResponseBodyToGuildserviceGuild(body.Guild)
	}

	return v
}

// NewGetSingleGuildNotFound builds a GuildService service GetSingleGuild
...
// NewGetSingleGuildInternal builds a GuildService service GetSingleGuild
...
// NewGetGuildMembersResultOK builds a "GuildService" service "GetGuildMembers"
// endpoint result from a HTTP "OK" response.
func NewGetGuildMembersResultOK(body *GetGuildMembersResponseBody) *guildservice.GetGuildMembersResult {
	v := &guildservice.GetGuildMembersResult{}
	if body.Members != nil {
		v.Members = make([]*guildservice.GuildMember, len(body.Members))
		for i, val := range body.Members {
			v.Members[i] = unmarshalGuildMemberResponseBodyToGuildserviceGuildMember(val)
		}
	}
...
// NewGetGuildMembersNotFound builds a GuildService service GetGuildMembers
// endpoint not_found error.
...
// NewGetGuildMembersInternal builds a GuildService service GetGuildMembers
// endpoint internal error.
...
// NewGetGuildMasterAddressResultOK builds a "GuildService" service
// "GetGuildMasterAddress" endpoint result from a HTTP "OK" response.
func NewGetGuildMasterAddressResultOK(body *GetGuildMasterAddressResponseBody) *guildservice.GetGuildMasterAddressResult {
	v := &guildservice.GetGuildMasterAddressResult{
...
// NewGetGuildMasterAddressNotFound builds a GuildService service
...
// NewGetGuildMasterAddressInternal builds a GuildService service
...
// NewGetGuildDefaultMemberResultOK builds a "GuildService" service
// "GetGuildDefaultMember" endpoint result from a HTTP "OK" response.
func NewGetGuildDefaultMemberResultOK(body *GetGuildDefaultMemberResponseBody) *guildservice.GetGuildDefaultMemberResult {
	v := &guildservice.GetGuildDefaultMemberResult{}
	if body.DefaultMember != nil {
		v.DefaultMember = unmarshalGuildMemberResponseBodyToGuildserviceGuildMember(body.DefaultMember)
	}

	return v
}

// NewGetGuildDefaultMemberNotFound builds a GuildService service
...
// NewGetGuildDefaultMemberInternal builds a GuildService service
...
// NewEnterGuildResultOK builds a "GuildService" service "EnterGuild" endpoint
// result from a HTTP "OK" response.
func NewEnterGuildResultOK(body *EnterGuildResponseBody) *guildservice.EnterGuildResult {
	v := &guildservice.EnterGuildResult{
...
// NewEnterGuildNotFound builds a GuildService service EnterGuild endpoint
// not_found error.
...
// NewEnterGuildInternal builds a GuildService service EnterGuild endpoint
// internal error.
...
// NewLeaveGuildResultOK builds a "GuildService" service "LeaveGuild" endpoint
// result from a HTTP "OK" response.
func NewLeaveGuildResultOK(body *LeaveGuildResponseBody) *guildservice.LeaveGuildResult {
	v := &guildservice.LeaveGuildResult{
...
// NewLeaveGuildNotFound builds a GuildService service LeaveGuild endpoint
// not_found error.
...
// NewLeaveGuildInternal builds a GuildService service LeaveGuild endpoint
// internal error.
...
// NewGetGuildMarketsResultOK builds a "GuildService" service "GetGuildMarkets"
// endpoint result from a HTTP "OK" response.
func NewGetGuildMarketsResultOK(body *GetGuildMarketsResponseBody) *guildservice.GetGuildMarketsResult {
	v := &guildservice.GetGuildMarketsResult{}
	if body.Markets != nil {
		v.Markets = make([]*guildservice.Market, len(body.Markets))
		for i, val := range body.Markets {
			v.Markets[i] = unmarshalMarketResponseBodyToGuildserviceMarket(val)
		}
	}
...
// NewGetGuildMarketsNotFound builds a GuildService service GetGuildMarkets
// endpoint not_found error.
...
// NewGetGuildMarketsInternal builds a GuildService service GetGuildMarkets
// endpoint internal error.
...
// NewGetAccountPortfolioResultOK builds a "GuildService" service
// "GetAccountPortfolio" endpoint result from a HTTP "OK" response.
func NewGetAccountPortfolioResultOK(body *GetAccountPortfolioResponseBody) *guildservice.GetAccountPortfolioResult {
	v := &guildservice.GetAccountPortfolioResult{}
	if body.Data != nil {
		v.Data = unmarshalSingleAccountPortfolioResponseBodyToGuildserviceSingleAccountPortfolio(body.Data)
	}

	return v
}

// NewGetAccountPortfolioNotFound builds a GuildService service
...
// NewGetAccountPortfolioInternal builds a GuildService service
...
// NewGetAccountPortfoliosResultOK builds a "GuildService" service
// "GetAccountPortfolios" endpoint result from a HTTP "OK" response.
func NewGetAccountPortfoliosResultOK(body *GetAccountPortfoliosResponseBody) *guildservice.GetAccountPortfoliosResult {
	v := &guildservice.GetAccountPortfoliosResult{}
	if body.Data != nil {
		v.Data = unmarshalAccountPorfoliosResponseBodyToGuildserviceAccountPorfolios(body.Data)
	}

	return v
}

// NewGetAccountPortfoliosNotFound builds a GuildService service
...
// NewGetAccountPortfoliosInternal builds a GuildService service
