...
//
// GuildService HTTP server types
//
// Command:
...
// the "GetAllGuilds" endpoint of the "GuildService" service.
func NewGetAllGuildsResponseBody(res *guildservice.GetAllGuildsResult) *GetAllGuildsResponseBody {
	body := &GetAllGuildsResponseBody{}
	if res.Guilds != nil {
		body.Guilds = make([]*GuildResponseBody, len(res.Guilds))
		for i, val := range res.Guilds {
			body.Guilds[i] = marshalGuildserviceGuildToGuildResponseBody(val)
		}
	}
	return body
}
...
// of the "GetSingleGuild" endpoint of the "GuildService" service.
func NewGetSingleGuildResponseBody(res *guildservice.GetSingleGuildResult) *GetSingleGuildResponseBody {
	body := &GetSingleGuildResponseBody{}
	if res.Guild != nil {
		body.Guild = marshalGuildserviceGuildToGuildResponseBody(res.Guild)
	}
	return body
}

// NewGetGuildMembersResponseBody builds the HTTP response body from the result
// of the "GetGuildMembers" endpoint of the "GuildService" service.
func NewGetGuildMembersResponseBody(res *guildservice.GetGuildMembersResult) *GetGuildMembersResponseBody {
	body := &GetGuildMembersResponseBody{}
	if res.Members != nil {
		body.Members = make([]*GuildMemberResponseBody, len(res.Members))
		for i, val := range res.Members {
			body.Members[i] = marshalGuildserviceGuildMemberToGuildMemberResponseBody(val)
		}
	}
	return body
}
...
// result of the "GetGuildMasterAddress" endpoint of the "GuildService" service.
func NewGetGuildMasterAddressResponseBody(res *guildservice.GetGuildMasterAddressResult) *GetGuildMasterAddressResponseBody {
...
// result of the "GetGuildDefaultMember" endpoint of the "GuildService" service.
func NewGetGuildDefaultMemberResponseBody(res *guildservice.GetGuildDefaultMemberResult) *GetGuildDefaultMemberResponseBody {
	body := &GetGuildDefaultMemberResponseBody{}
	if res.DefaultMember != nil {
		body.DefaultMember = marshalGuildserviceGuildMemberToGuildMemberResponseBody(res.DefaultMember)
	}
	return body
}
...
func NewEnterGuildResponseBody(res *guildservice.EnterGuildResult) *EnterGuildResponseBody {
...
func NewLeaveGuildResponseBody(res *guildservice.LeaveGuildResult) *LeaveGuildResponseBody {
...
// of the "GetGuildMarkets" endpoint of the "GuildService" service.
func NewGetGuildMarketsResponseBody(res *guildservice.GetGuildMarketsResult) *GetGuildMarketsResponseBody {
	body := &GetGuildMarketsResponseBody{}
	if res.Markets != nil {
		body.Markets = make([]*MarketResponseBody, len(res.Markets))
		for i, val := range res.Markets {
			body.Markets[i] = marshalGuildserviceMarketToMarketResponseBody(val)
		}
	}
	return body
}
...
// result of the "GetAccountPortfolio" endpoint of the "GuildService" service.
func NewGetAccountPortfolioResponseBody(res *guildservice.GetAccountPortfolioResult) *GetAccountPortfolioResponseBody {
	body := &GetAccountPortfolioResponseBody{}
	if res.Data != nil {
		body.Data = marshalGuildserviceSingleAccountPortfolioToSingleAccountPortfolioResponseBody(res.Data)
	}
	return body
}

// NewGetAccountPortfoliosResponseBody builds the HTTP response body from the
// result of the "GetAccountPortfolios" endpoint of the "GuildService" service.
func NewGetAccountPortfoliosResponseBody(res *guildservice.GetAccountPortfoliosResult) *GetAccountPortfoliosResponseBody {
	body := &GetAccountPortfoliosResponseBody{}
	if res.Data != nil {
		body.Data = marshalGuildserviceAccountPorfoliosToAccountPorfoliosResponseBody(res.Data)
	}
	return body
}

// NewGetAllGuildsNotFoundResponseBody builds the HTTP response body from the
// result of the "GetAllGuilds" endpoint of the "GuildService" service.
...
// result of the "GetSingleGuild" endpoint of the "GuildService" service.
...
// the result of the "GetGuildMembers" endpoint of the "GuildService" service.
...
// result of the "EnterGuild" endpoint of the "GuildService" service.
...
// result of the "LeaveGuild" endpoint of the "GuildService" service.
...
// the result of the "GetGuildMarkets" endpoint of the "GuildService" service.
...
// from the result of the "GetAccountPortfolio" endpoint of the "GuildService"
// service.
...
// from the result of the "GetAccountPortfolios" endpoint of the "GuildService"
// service.
...
// NewGetSingleGuildPayload builds a GuildService service GetSingleGuild
// endpoint payload.
func NewGetSingleGuildPayload(guildID string) *guildservice.GetSingleGuildPayload {
...
// NewGetGuildMembersPayload builds a GuildService service GetGuildMembers
// endpoint payload.
func NewGetGuildMembersPayload(guildID string) *guildservice.GetGuildMembersPayload {
...
// NewGetGuildMasterAddressPayload builds a GuildService service
// GetGuildMasterAddress endpoint payload.
func NewGetGuildMasterAddressPayload(guildID string) *guildservice.GetGuildMasterAddressPayload {
...
// NewGetGuildDefaultMemberPayload builds a GuildService service
// GetGuildDefaultMember endpoint payload.
func NewGetGuildDefaultMemberPayload(guildID string) *guildservice.GetGuildDefaultMemberPayload {
...
// NewEnterGuildPayload builds a GuildService service EnterGuild endpoint
// payload.
func NewEnterGuildPayload(body *EnterGuildRequestBody, guildID string) *guildservice.EnterGuildPayload {
...
// NewLeaveGuildPayload builds a GuildService service LeaveGuild endpoint
// payload.
func NewLeaveGuildPayload(body *LeaveGuildRequestBody, guildID string) *guildservice.LeaveGuildPayload {
...
// NewGetGuildMarketsPayload builds a GuildService service GetGuildMarkets
// endpoint payload.
func NewGetGuildMarketsPayload(guildID string) *guildservice.GetGuildMarketsPayload {
...
// NewGetAccountPortfolioPayload builds a GuildService service
// GetAccountPortfolio endpoint payload.
func NewGetAccountPortfolioPayload(guildID string, injectiveAddress string) *guildservice.GetAccountPortfolioPayload {
...
// NewGetAccountPortfoliosPayload builds a GuildService service
// GetAccountPortfolios endpoint payload.
func NewGetAccountPortfoliosPayload(guildID string, injectiveAddress string) *guildservice.GetAccountPortfoliosPayload {
